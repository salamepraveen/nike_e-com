...
const Hero = () => {
  ...
  return (
    ...
    <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full ma-xl:padding-x pt-8">
    ...
    <div className='relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-center'>
      <img
        ...
        <div className="flex sm:gap-6 gap-4 absolute -bottom-[5%] sm:left-[10%] max-sm:px-6">
          {shoes.map((shoe) =>(
              <div key={shoe} >
                <ShoeCard imgURL={shoe} changeBigShoeImage={(shoe)=>{setBigShoeImg(shoe)}} bigShoeImage={bigShoeImage} />
              </div>
          ))}
        </div>
    </div>
